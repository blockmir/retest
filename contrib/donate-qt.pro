...
RESOURCES += src/qt/donate.qrc src/qt/donate_locale.qrc

TRANSLATIONS += src/qt/locale/donate_bg.ts \
                src/qt/locale/donate_de.ts \
                src/qt/locale/donate_en.ts \
                src/qt/locale/donate_es.ts \
                src/qt/locale/donate_fi.ts \
                src/qt/locale/donate_fr.ts \
                src/qt/locale/donate_it.ts \
                src/qt/locale/donate_ja.ts \
                src/qt/locale/donate_pl.ts \
                src/qt/locale/donate_pt.ts \
                src/qt/locale/donate_ru.ts \
                src/qt/locale/donate_sk.ts \
                src/qt/locale/donate_sv.ts \
                src/qt/locale/donate_vi.ts \
                src/qt/locale/donate_zh_CN.ts \
                src/qt/locale/donate_zh_TW.ts
