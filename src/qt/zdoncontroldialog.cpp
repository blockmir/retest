...
std::list<std::string> ZDonControlDialog::listSelectedMints;
std::list<CZerocoinMint> ZDonControlDialog::listMints;
...
void ZDonControlDialog::updateLabels()
{
    ...
    privacyDialog->setZDonControlLabels(nAmount, listSelectedMints.size());
}

std::vector<CZerocoinMint> ZDonControlDialog::GetSelectedMints()
{
