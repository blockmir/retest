Contributing to DONATE Core
============================

The DONATE Core project operates an open contributor model where anyone is
...
The following applies to code changes to the DONATE Core project, and is not to be
confused with overall DONATE Network Protocol consensus changes.

Whether a pull request is merged into DONATE Core rests with the project merge
...
Patches that change DONATE consensus rules are considerably more involved than
...
Where a patch set proposes to change the DONATE consensus, it must have been
...
The project leader is the release manager for each DONATE Core release.
