...
In order to support loading of multiple wallets in donate-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is donate.cpp.
...
Changes to donate.cpp
----------------------
donate.cpp is the entry point into donate-qt, and as such, will require some minor modifications to provide hooks for
